        ...
        try:
            ...
            for item in question_data:
                ...
                for choice in choices_data:
                    ...
                    choice_intance = TestChoices.objects.create(
                        question=question_instance,
                        item_choice_text=choice.get('choice', ''),
                        isAnswer=choice.get('isAnswer', False)
                    )
                    choice_list.append(TestChoicesSerializer(choice_intance).data)

            return Response({"status": "success", "questions": question_list, "choices": choice_list}, status=status.HTTP_201_CREATED)
